  ...
  return (
    <>
      ...
      <main className="main-home-container">
        ...
        {/* 5. SECCIÓN: NUESTROS INTEGRANTES */}
        <section id="nosotros" className="team-container" style={{ marginBottom: '50px', padding: '20px 0' }}>
        ...
        {/* 6. SECCIÓN: EMPRESAS QUE CONFÍAN */}
        ...
        {/* 4. MAPA INTERACTIVO */}
        <div className="profile-section-block mapa-home-block">
          <iframe 
